                        ...
                        <div class="col">
                            <div class="order-area">
                                ...
                                <div class="order-price">
                                    <ul class="total-order" data-animate="animate__fadeInUp">
                                        <li>
                                            ...
                                            <span class="order-date"><span class="order-date">23th jan 2024 3:04 pm</span></span>
                                        </li>
                                        <li>
                                ...
                                <div class="order-details">
                                    ...
                                    <a href="track-page.html" class="tracking-link btn btn-style2" data-animate="animate__fadeInUp">Tracking details</a>
                                </div>
                                <!-- order-details start -->
