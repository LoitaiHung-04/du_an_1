                                ...
                                <ul class="banner-grid-ul">
                                        ...
                                        <div class="banner-block">
                                            <a href="collection.html">
                                                <span class="image-block">
                                                    <img src="assets/banner/home-banner-1.jpg" class="img-fluid" alt="big-banner1">
                                                </span>
                                    ...
                                    <li class="banner-grid-li big-banner">
                                        <div class="banner-block">
                                            <a href="collection.html">
                                                <span class="image-block">
                                                    <img src="assets/banner/home-banner-2.jpg" class="img-fluid" alt="big-banner2">
                                                </span>
                                                <div class="banner-content banner-text-left banner-content-right">
                                    ...
                                    <li class="banner-grid-li big-banner">
                                        <div class="banner-block">
                                            <a href="collection.html">
                                                <span class="image-block">
                                                    <img src="assets/banner/home-banner-3.jpg" class="img-fluid" alt="big-banner3">
                                                </span>
                                                <div class="banner-content banner-text-left banner-content-right">
