                        ...
                        <li class="footer-li footer-logo" data-animate="animate__fadeInUp">
                            <div class="footer-content">
                                <a href="index.html" class="theme-logo">
                                    <img src="/du_an_1/assets/images/logo/logo.png" class="img-fluid" alt="footer-logo">
                                </a>
                                ...
                                <div class="app-code">
                                    ...
                                    <div class="code-1">
                                        ...
                                        <a href="index.html" class="image">
                                            <img src="/du_an_1/assets/images/logo/home-footer2.jpg" class="img-fluid desk-img" alt="as-icon-02">
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <ul class="ft-copryright-ul">
                        <li class="ft-copryright-li ft-payment">
                            <ul class="payment-icon">
                                <li>
                                    <a href="index.html">
                                        <img src="/du_an_1/assets/images/logo/pay-1.jpg" class="img-fluid" alt="pay-1">
                                    </a>
                                </li>
                                <li>
                                    <a href="index.html">
                                        <img src="/du_an_1/assets/images/logo/pay-2.jpg" class="img-fluid" alt="pay-2">
                                    </a>
                                </li>
                                <li>
                                    <a href="index.html">
                                        <img src="/du_an_1/assets/images/logo/pay-3.jpg" class="img-fluid" alt="pay-3">
                                    </a>
                                </li>
                                <li>
                                    <a href="index.html">
                                        <img src="/du_an_1/assets/images/logo/pay-4.png" class="img-fluid" alt="pay-4">
                                    </a>
                                </li>
                            </ul>
                        </li>
        ...
        <div class="mobile-vega-menu" id="mobile-vega-menu">
            <div class="vega-close">
                <button class="vega-close-btn">
                    <span class="vega-close-icon"><svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1">
                    ...
                    <div class="quick-view-content">
                        <div class="pro-nprist">
                            ...
                            <div class="product-payment-image">
                                <ul class="payment-icon">
                                    <li>
                                        <a href="index.html"><svg viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg" role="img" width="38" height="24" aria-labelledby="pi-visa">
                                    ...
                                    <li>
                                        <a href="index.html"><svg viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg" role="img" width="38" height="24" aria-labelledby="pi-master">
                                    ...
                                    <li>
                                        <a href="index.html"><svg xmlns="http://www.w3.org/2000/svg" role="img" aria-labelledby="pi-american-express" viewBox="0 0 38 24" width="38" height="24">
                                    ...
                                    <li>
                                        <a href="index.html"><svg viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg" width="38" height="24" role="img" aria-labelledby="pi-paypal">
    ...
    $(document).ready(function() {
        ...
        $('#timkiem').keyup(debounce(function() {
            ...
            if (search !== '') {
                ...
                $.getJSON('/du_an_1/public/compare.json', function(data) {
                    let found = false;
                    $.each(data, function(key, value) {
                        if (value.ten_san_pham.search(expression) !== -1) {
                            found = true;
                            ...
                            $('#result').append(
                                ...
                                value.gia_san_pham + ' VNĐ</span></div></li>'
                            );
                        }
                    });
                    if (!found) {
