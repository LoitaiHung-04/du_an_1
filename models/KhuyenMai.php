...
class KhuyenMai
{
    ...
    public function form($ten_khuyen_mai, $mo_ta, $giam_gia, $ngay_bat_dau, $ngay_ket_thuc, $trang_thai, $so_luong, $ma, $id = "")
    {
        if ($id != "") {
            ...
            $sql = "INSERT INTO `khuyen_mais` (`ten_khuyen_mai`,`ma`, `mo_ta`, `giam_gia`, 
                                                `ngay_bat_dau`, `ngay_ket_thuc`, `trang_thai`, 
                                                `so_luong`) 
                    VALUES (?, ?, ?, ?, ?, ?, ?,?)";
            $params = [
